...
if (fs.existsSync(user_data_filename)) {
    ...
    console.log('File ' + user_data_filename + " doesnt exist!");
}

app.get("/set_cookie", function (request, response) {
    response.cookie('myname', 'Jonathan Kan', { maxAge: 5 * 1000 }).send('cookie set');
});
...
app.post("/register", function (request, response) {
    ...
    fs.writeFileSync(user_data_filename, output_data, 'utf-8');
